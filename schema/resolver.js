    ...
    Mutation:{
      createUser: async(_,{input})=>{
        ...
        const [user,created] =  await User.findOrCreate({
         ...
         defaults:{name:input.name,phoneNumber:input.phoneNumber,password:hash,code,status:false}
            ...
            if(created){
                handleEmail(input.email,`Dear ${input.name}, your account has been created successfully. <a href="https://chainmedic-patient.herokuapp.com/verify">Click here</a> https://chainmedic-patient.herokuapp.com/verify  and use the following code to activate your account <b>${code}</b>`,
      ...
      createHospital: async(_,{input})=>{
        ...
        const [hospital,created] =  await Hospital.findOrCreate({
           ...
           if(created){
            handleEmail(input.email,`Dear ${input.name}, your account has been created successfully.  <a href="https://chainmedic-hos.herokuapp.comverify">Click here</a> https://chainmedic-hos.herokuapp.com/verify and use the following code to activate your account <b>${code}</b>`,
            "ChainMedic | Verify Account")
